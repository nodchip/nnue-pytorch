...
class NNUE(pl.LightningModule):
  ...
  def __init__(
      ...
      num_epochs_to_adjust_lr=500, min_newbob_scale=1e-5, momentum=0.0, in_scaling=600.0,
      out_scaling=600.0):
  ...
  def step_(self, batch, batch_idx, loss_type):
    ...
    q = self(us, them, white, black) * nnue2score / in_scaling
    t = outcome * (1.0 - self.label_smoothing_eps * 2.0) + self.label_smoothing_eps
    p = (score / out_scaling).sigmoid()
