...
class SparseBatch(ctypes.Structure):
    ...
    def get_tensors(self, device):
        ...
        white = torch.sparse_coo_tensor_unsafe(iw, white_values, (self.size, self.num_inputs))
        black = torch.sparse_coo_tensor_unsafe(ib, black_values, (self.size, self.num_inputs))
